...
struct add_gear
{
	typedef ShipGear<G1::cannons + G2::cannons, G1::masts + G2::masts, G1::oars + G2::oars> type;
};
...
/*template <class Gear, class OtherGear>
Squad<> expected_booty(Squad<Gear> const &, Squad<OtherGear> const &)
{ return Squad<>;
}*/
...
template <class Gear, class OtherGear>
 typename expected_booty_helper<Squad<Gear>, Squad<OtherGear>, is_bigger<Gear,OtherGear>::value>::result_type  expected_booty(const Squad<Gear> &a, const Squad<OtherGear> &b) {
     expected_booty_helper<Squad<Gear>, Squad<OtherGear>, is_bigger<Gear,OtherGear>::value> resu(a,b);
     return resu.result;
}
